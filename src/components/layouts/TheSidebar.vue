      ...
      slides: [
        {
          ...
          img: 'https://cdn.trip123.com/demo/YpxKKNlSPdmwotO3u8An.jpg',
          link: 'https://trip123.com/'
        },
        {
          title: '《Laravel 进阶课程 - 从零构建论坛系统》',
          img: 'https://cdn.trip123.com/demo/iNanVVOXdnYQ6jRfMdWE.png',
          link: 'https://trip123.com/'
        },
        {
          title: '《Laravel 教程实战高级 - 构架 API 服务器》',
          img: 'https://cdn.trip123.com/demo/tEd4GxhMp6VMh9e0hrUH.jpg',
          link: 'https://trip123.com/'
        }
      ],
      activeUsers: [], // 活跃用户
