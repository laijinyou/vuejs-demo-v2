<template>
  <div class="col-md-9 left-col pull-right">
      ...
      <div class="panel-body vote-box text-center">
        ...
        <div class="voted-users">
          <div class="user-lists">
            <span v-for="likeUser in likeUsers" :key="likeUser">
    ...
    <Modal :show.sync="showQrcode" class="text-center">
      ...
      <div>
        <p class="text-md">如果你想学习更多前端的知识，Vue.js Demo 是个不错的开始</p>
        <div class="payment-qrcode inline-block">
          <h5>扫一扫打开 Vue.js Demo</h5>
          <p><qrcode-vue value="https://trip123.com/" :size="160"></qrcode-vue></p>
        </div>
      </div>
